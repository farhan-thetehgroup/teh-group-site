  ...
  return (
    ...
    >
      <div className="p-6 sm:p-8 lg:p-10">
        ...
        <div className="flex items-start justify-between mb-8">
          <div className="flex-1">
            <h1
              ...
              className="text-3xl md:text-4xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 mb-2">
              Privacy Policy
            </h1>
          ...
          <button
            onClick={onClose}
            className="ml-4 w-10 h-10 rounded-full bg-black/40 hover:bg-black/60 border border-white/20 hover:border-white/40 transition-all duration-300 flex items-center justify-center text-white group flex-shrink-0"
        ...
        {/* Content */}
        <div className="prose prose-invert prose-lg max-w-none space-y-8 text-slate-200">
          <section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-emerald-400 mt-8 mb-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-slate-300 ml-4">
              ...
              <li>
                ...
                "We", "Us" or "Our" in this Agreement) refers to TRIUMP EMINENT
                HUB Sdn Bhd, Room 2508, 25th Floor, Tower One Lippo Centre,
              ...
              <li>
                <strong>Website</strong> refers to TEH Group Company Profile,
                accessible from{" "}
                <a
                  href="https://thetehgroup.com"
                  className="text-emerald-400 hover:text-emerald-300"
                  target="_blank"
                  rel="noopener noreferrer">
                  https://thetehgroup.com
                </a>
              </li>
              <li>
          ...
          <section>
            ...
            <h4 className="text-lg font-semibold text-cyan-300 mt-4 mb-2">
              Personal Data
            </h4>
            <p className="text-slate-300 leading-relaxed mb-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-slate-300 ml-4">
              <li>
                By email:{" "}
                <a
                  href="mailto:hello@thetehgroup.com"
                  className="text-emerald-400 hover:text-emerald-300">
